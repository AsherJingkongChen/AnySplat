...
from anysplat.dataset.shims.bounds_shim import apply_bounds_shim
from anysplat.dataset.shims.normalize_shim import apply_normalize_shim
from anysplat.dataset.shims.patch_shim import apply_patch_shim
from anysplat.dataset.types import BatchedExample, DataShim
from anysplat.geometry.projection import sample_image_grid

from anysplat.model.encoder.heads.vggt_dpt_gs_head import VGGT_DPT_GS_Head
from anysplat.model.encoder.vggt.utils.geometry import (
    batchify_unproject_depth_map_to_point_map,
    unproject_depth_map_to_point_map,
)
from anysplat.model.encoder.vggt.utils.pose_enc import pose_encoding_to_extri_intri
from anysplat.utils.geometry import get_rel_pos  # used for model hub
...
from anysplat.model.encoder.vggt.models.vggt import VGGT
...
class EncoderAnySplat(Encoder[EncoderAnySplatCfg]):
    ...
    def __init__(self, cfg: EncoderAnySplatCfg) -> None:
        super().__init__(cfg)
        model_full = VGGT.from_pretrained(cfg.pretrained_weights) if cfg.pretrained_weights else VGGT()
